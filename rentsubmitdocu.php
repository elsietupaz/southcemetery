...
?>     
                    ...
                    <a class="logo" href="customerdashboard.php" style="font-size:15px; margin-left: 10px;"><?php echo $navtitle; ?></a>
                        ...
                        <li class="scroll-to-section"><a href="customerdashboard.php">Home</a></li>
                            ...
                            <li class="scroll-to-section"><a href="rentlot.php" active>Rent A Lot</a></li>
...
?>
  ...
  <?php require_once 'db.php'; ?>
    ...
    <section class="section" id="submitdocu">
...
?>
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <form action="#" onsubmit="if(document.getElementById('agree').checked) { return true; } else { alert('Please indicate that you have read and agree to the Terms and Conditions and Privacy Policy'); return false; }">
                     ...
                     <input type="checkbox" name="checkbox" value="check" id="agree" required /> I have read and agree to the <a target="_blank" rel="noopener noreferrer" href="termsandcondition.php" class="btn-link">Terms and Condition</a> and <a target="_blank" rel="noopener noreferrer" href="privacypolicy.php" class="btn-link"> Privacy Policy</a>
...
if(isset($_POST["submit"])){ 
    ...
    if(!empty($_FILES["deathcert"]["name"])) { 
        ...
        if(in_array($fileType, $allowTypes)){ 
            ...
            $image = $_FILES['deathcert']['tmp_name']; 
            ...
            $insert = $conn->query("INSERT INTO tblrentsubmit (payer, refnum, fullname, yeardeath, pname) VALUES ('$fname', '$refnum', '$fullname', '$date', '$imgContent')");
            ...
            if($insert){ 
                ...
                swal("Success!", "Information submitted successfully!","success").then( () => {
