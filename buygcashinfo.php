...
if(isset($_POST["submit"])){ 
    ...
    if(!empty($_FILES["receipt"]["name"])) { 
        ...
        if(in_array($fileType, $allowTypes)){ 
            ...
            $insert = $conn->query("INSERT INTO gcashyearlypayments(reference_number, customer_name, mobile, amount, date, imgreceipt) VALUES ('$refnum', '$name', '$mobile', '$amount', '$date', '$imgContent')");
            ...
            if($insert){ 
                ...
                location.href = 'buylotsubmitdocu.php'
