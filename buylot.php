...
?>     
                   <a class="logo" href="customerdashboard.php" style="font-size:15px; margin-left: 10px;"><?php echo $navtitle; ?></a>
                        ...
                        <li class="scroll-to-section"><a href="customerdashboard.php">Home</a></li>
                            ...
                            <li class="scroll-to-section"><a href="buylot.php" class="active">Buy Lot</a></li>
                  ...
                  <?php
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                                      ...
                                      <tr>
                      <td><?php echo  $id ?></td>
                      <!-- <form action="buylotcharge.php" method="post"> -->
                      ...
                      <!-- <input type="submit" class="form-control btn-warning" id="submit" name="submit" value="Pay with Paypal"> -->
                        <!-- <br> -->
                        <!-- </form> -->
                        <input type="button" onclick="window.location.href='buypaywithgcash.php#buy'" class="form-control btn-primary" id="gcash" name="gcash" value="Pay with GCash">
