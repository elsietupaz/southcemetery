...
<?php
   ...
   if (isset($_POST['signup'])) {
    ...
    $s = "SELECT username FROM adminreg where username='".$username."'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        else if(mysqli_query($conn, "INSERT INTO adminreg(lastname, firstname, middlename, email, mobile, username, password, cpassword, date_register) VALUES('" . $lname . "', '" . $fname . "', '" . $mname . "', '" . $email . "', '" . $mobile . "', '" . $username . "', '" . $hashed_password . "', '" . $hashed_cpassword . "', NOW())")) {
            ?>
            <script>
            swal({
              title: "Success!",
                ...
                <p>Please fill in the form below. </p>
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" autocomplete="off">
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input onkeypress='return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32) || (event.charCode == 44))' type="text" id="lname" class="form-control" name="lname" required autofocus>
                        ...
                        <label for="fname" class="col-md-4 col-form-label text-md-right">Firstname</label>
                            <div class="col-md-6">
                                <input onkeypress='return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32) || (event.charCode == 44))' type="text" id="fname" class="form-control" name="fname"  required >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input onkeypress='return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32) || (event.charCode == 44))' type="text" id="mname" class="form-control" name="mname" >
                     ...
                     <center> <input type="checkbox" name="checkbox" value="check" id="agree" required /> I have read and agree to the <a href="#" data-target="#modalTC" data-toggle="modal" class="btn-link">Terms and Condition</a> and <a href="#" data-target="#modalDP" data-toggle="modal" class="btn-link"> Privacy Policy</a></center> 
                      ...
                      <br>
                        ...
                        <br>
                            ...
                            <a href="adminlogin.php" class="form-control btn btn-link">
