...
<link rel="shortcut icon" href="icon.ico" />
  ...
  <title><?php echo $nav; ?> Dashboard</title>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.24.0/moment.js"></script>
        ...
        <div class="container-fluid">
                ...
                <div class="card-body">
                  ...
                  <div class="chart-bar" style="height:auto; width:auto;">

                  

                    <canvas id="myusers"></canvas>

                    <button class="btn btn-info" id="print-chart-btn">Print</button>
                ...
                <div class="card-header py-3">
                  ...
                  <h6 class="m-0 font-weight-bold text-primary">Number of Deaths Per Year</h6>
                ...
                <div class="card-body">
                  ...
                  <div class="chart-bar" style="height:auto; width:auto;">
                    ...
                    <button class="btn btn-info" id="print-chart-btn1">Print</button>
...
<div class="card-header py-3">
  ...
  <h6 class="m-0 font-weight-bold text-primary">Number of Visitors Per Month</h6>
...
<div class="card-body">
  ...
  <div class="chart-bar" style="height:auto; width:auto;">
    ...
    <button class="btn btn-info" id="print-chart-btn2">Print</button>
...
$('#print-chart-btn1').on('click', function() {
    ...
    var canvas = document.querySelector("#death");

    var canvas_img = canvas.toDataURL("image/png",1.0); //JPEG will not match background color

    var pdf = new jsPDF('landscape','in', 'legal'); //orientation, units, page size
    
    pdf.text('sdadadasdasd', 10, 10);
...
$('#print-chart-btn').on('click', function() {
    ...
    var canvas = document.querySelector("#myusers");
...
$('#print-chart-btn2').on('click', function() {
  ...
  <script type="text/javascript" src="js/numdeath.js"></script>

  <script type="text/javascript" src="js/numusers.js"></script>
