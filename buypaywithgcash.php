...
<br>
      ...
      <div class="modal-footer">
       ...
       <button type="button" onclick="javascript:window.location.href='buylot.php#buy';" class="btn btn-danger btn-sm" data-dismiss="modal">NO, THANK YOU</button>
      </div>
    </div>
  </div>
</div>
...
<script type="text/javascript">
   ...
   <h1 class="mt-4">GCASH PAYMENT</h1>
               ...
               <a href="buygcashinfo.php#info" style="float: right;">Next Step >></a>
