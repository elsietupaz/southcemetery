...
<link rel="shortcut icon" href="icon.ico" />
  <title><?php echo $nav; ?> Monthly Sales Balance</title>
      ...
      <div id="content">
        ...
        <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Monthly Sales of GCash Balance</h6>
                </div>
                <div class="card-body">
...
?>
  ...
  <script type="text/javascript" src="js/gcashother.js"></script>
