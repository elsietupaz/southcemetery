...
<head>
  ...
  <title><?php echo $nav; ?> GCash Payments</title>
      ...
      <div class="card border-left-primary shadow h-100 py-2">
        <div class="card-body">
          ...
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-lg font-weight-bold text-primary text-uppercase mb-1">RENT A LOT PAYMENT</div>
              <a href="gcashrentalpayments.php" class="text-xs font-weight-bold text-dark text-uppercase mb-1">View Details</a>
            </div>
            <div class="col-auto">
    ...
    <div class="col-xl-4 col-md-6 mb-4">
      <div class="card border-left-success shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
            <div class="text-lg font-weight-bold text-success text-uppercase mb-1">BUY A LOT PAYMENT</div>
              <a href="gcashyearlypayment.php" class="text-xs font-weight-bold text-dark text-uppercase mb-1">View details</a>
            </div>
            <div class="col-auto">
            <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
            </div>
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <a href="gcashotherpayments.php" class="text-xs font-weight-bold text-dark text-uppercase mb-1">View details</a>
            </div>
            <div class="col-auto">
              <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
            </div>
