...
<head>
  ...
  <title><?php echo $nav; ?> GCash Archive</title>
        ...
        <div class="card-body">
          ...
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <a href="archivegcashrental.php" class="text-xs font-weight-bold text-dark text-uppercase mb-1">View Details</a>
            </div>
            <div class="col-auto">
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            ...
            <div class="text-lg font-weight-bold text-success text-uppercase mb-1">BUY A LOT PAYMENT</div>
              <a href="archivegcashbuy.php" class="text-xs font-weight-bold text-dark text-uppercase mb-1">View details</a>
            </div>
            <div class="col-auto">
            <i class="fas fa-archive fa-2x text-gray-300"></i>
            </div>
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <a href="archivegcashother.php" class="text-xs font-weight-bold text-dark text-uppercase mb-1">View details</a>
            </div>
            <div class="col-auto">
              <i class="fas fa-archive fa-2x text-gray-300"></i>
            </div>
